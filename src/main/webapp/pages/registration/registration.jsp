        ...
        <div class="col-6">
            <form action="/registration" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="name" class="form-control" id="name" aria-describedby="name" minlength="3" maxlength="15" required>
                </div>

                <div class="mb-3">
                    <label for="login" class="form-label">Login</label>
                    <input type="text" name="login" class="form-control" id="login" aria-describedby="login" minlength="3" maxlength="15" required>
                </div>
