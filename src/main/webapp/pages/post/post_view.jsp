                                        ...
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                ...
                                                <c:forEach items="${requestScope.post.likes}" var="like">
                                                    <li>
                                                        <a href="/userView?id=${like.user.id}" class="dropdown-item"
                                                           role="button" aria-disabled="true">${like.user.name}</a>
                                                    </li>
                                                </c:forEach>
                                            </ul>
                                        </div>
            ...
            <div class="row">
                ...
                <div class="mb-3">
                    ...
                    <c:forEach items="${requestScope.post.comments}" var="comment">
                        <p>
                            <a class="badge rounded-pill bg-dark" href="/userView?id=${comment.user.id}"
                               role="button">
